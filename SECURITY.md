...
SeftFlow is a self-hosted project. Deployers are responsible for protecting their admin key, model API keys, database, Redis, file storage, and reverse-proxy entrypoints.
