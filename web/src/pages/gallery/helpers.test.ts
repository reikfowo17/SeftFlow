...
describe("gallery helpers", () => {
  it("formats requested and actual size metadata", () => {
    expect(galleryEntrySizeLabel(entry({}))).toBe("Actual 1024x1024 · Requested 2048x2048");
    ...
    expect(galleryEntrySizeLabel(entry({ size: null, actual_size: null }))).toBe("Size unknown");
