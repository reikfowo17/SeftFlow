...
function shouldLocalizeTemplate(template: CanvasTemplateSummary, _locale: Locale): boolean {
...
export function localizeBuiltInTemplateLabel(label: string, _locale: Locale = DEFAULT_LOCALE): string | null {
