...
def _headline_from_payload(payload: PosterGenerationInput) -> str:
    ...
    if lines:
        return lines[0].removeprefix("summary: ")
...
class PosterRenderer:
    ...
    def _render_main_image(self, payload: PosterGenerationInput) -> Image.Image:
        ...
        if payload.price:
            ...
            draw.text((796, 78), f"Reference price {payload.price}", font=point_font, fill=(255, 255, 255))
        return canvas
    ...
    def _render_promo_poster(self, payload: PosterGenerationInput) -> Image.Image:
        ...
        _draw_wrapped_text(
            draw,
            payload.instruction or "Generate Image",
            cta_font,
            (180, 1298, 910, 1346),
            (255, 255, 255),
        )
