...
class ProductWorkflow(Base, TimestampMixin):
    """Product Product DAG  active=True  """
    ...
    title: Mapped[str] = mapped_column(String(255), default="ProductCreative workflow")
...
class SourceAsset(Base):
    """Product /Reference image Product """
