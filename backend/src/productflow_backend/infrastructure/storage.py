...
class LocalStorage:
    ...
    def resolve(self, relative_path: str) -> Path:
        ...
        try:
            ...
            raise ValueError("Storage path is out of bounds") from exc
        return resolved
    ...
    def _generate_variant(
        ...
        if max_edge <= 0:
            raise ValueError("Original image does not need a derived thumbnail")
        ...
        if rendered.width <= 0 or rendered.height <= 0:
            raise ValueError("invalidImage size")
