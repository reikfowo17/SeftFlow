# SeftFlow Architecture Health Review
...
- SeftFlow workbench, iterative image generation, gallery, settings page, and runtime configuration.
...
The Docker Compose self-hosted path is available, but SeftFlow is still not a full production platform:
