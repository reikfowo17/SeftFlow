...
SeftFlow is an open-source, self-hosted product creative workspace for solo merchants, small operations teams, and developers who want to manage AI creative workflows on their own infrastructure.
...
- Private environment files, runtime data, and build outputs are not publicly committed.
